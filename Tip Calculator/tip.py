...
class TipCalculator():
    def __init__(self):
        ...
        tip_percents = Label(window,text ="Tip Percentages",bg="sky blue",fg="black")
        tip_percents.grid(column=0,row=0,padx=15)

        bill_amount = Label(window,text ="Bill Amount",bg="sky blue",fg="black")
        ...
        tip_amount_lbl = Label(window,text ="Tip  Amount",bg="sky blue",fg="black")
        ...
        bill_total_lbl = Label(window,text ="Bill Total",bg="sky blue",fg="black")
